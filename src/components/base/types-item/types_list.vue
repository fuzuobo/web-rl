<template>
  ...
  <div v-show='updateShow' class="dialog dialog-active">
    ...
    <!-- <div style="width:400px;height:400px;border:1px solid red;">
      <input type="text" placeholder="请输入姓名：" style="display:block;margin:20px;height:30px;border:1px solid #9eafcd" v-model='newName'>
      <input type="text" placeholder="请输入证件号："style="display:block;margin:20px;height:30px;border:1px solid #9eafcd" v-model='newId'>
...
export default {
  ...
  methods:{
    ...
    createCustomer:function(){
      this.$http.post(this.apiUrl,this.item,{emulateJSON: true})
